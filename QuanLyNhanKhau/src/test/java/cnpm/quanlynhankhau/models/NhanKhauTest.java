...
class NhanKhauTest {
    ...
    void change() throws SQLException {
        NhanKhau NKtest = NhanKhauService.getNhanKhau("11");
        NKtest.change("Nguyễn Nam Khánh",null,"Phật giáo",null,null,
                LocalDate.parse("2002-09-30"),null,null,"Nhật Bản",null,
                "Đại học","12/12","IELTS 6.0","Sinh Viên",
                null,null,"test cập nhật database");
    }
}