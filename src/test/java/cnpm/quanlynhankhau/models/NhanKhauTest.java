...
//        TamTruVang truVang = new TamTruVang("000000000002", LocalDate.of(2002,11,12), LocalDate.of(2025,11,12), tamVang, tamTru, "");
...
//    }
    ...
    void removeTamTruVang() throws SQLException {
        ...
        DiaChi tamVang = new DiaChi("Hanoi", "Ba Dinh", "HHT", "4", "");
        DiaChi tamTru = new DiaChi("Hanoi", "HBT","DCV","12","");
        TamTruVang truVang = new TamTruVang("000000000001", LocalDate.of(2002,11,12), LocalDate.of(2025,11,12), tamVang, tamTru, "");
